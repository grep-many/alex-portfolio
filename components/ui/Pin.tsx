    ...
    <motion.div className="pointer-events-none z-60 flex h-80 w-full items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        ...
        >
          <>
            ...
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 size-45 rounded-[50%] bg-sky-500/8 shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,
        ...
        <>
          ...
          <motion.div className="absolute right-1/2 bottom-1/2 z-40 size-1 translate-x-[1.5px] translate-y-3.5 rounded-full bg-cyan-600 blur-[3px]" />
          <motion.div className="absolute right-1/2 bottom-1/2 z-40 size-0.5 translate-x-[0.5px] translate-y-3.5 rounded-full bg-cyan-300" />
        </>
      </div>
    </motion.div>
  );
