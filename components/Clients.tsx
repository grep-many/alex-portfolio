  ...
  return (
    <section id="testimonials" className="py-20">
      ...
      <div className="flex flex-col items-center max-lg:mt-10">
        <div className="relative flex h-[50vh] flex-col items-center justify-center overflow-hidden rounded-md antialiased md:h-120">
          ...
          {companies.map((company) => (
            <React.Fragment key={company.id}>
              <div className="flex max-w-32 gap-2 md:max-w-60">
                <Image src={company.img} alt={company.name} className="w-5 md:w-10" />
                <Image
                  src={company.nameImg}
                  alt={company.name}
